...
public class TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        //Setting up our tokens and AI
            ...
            System.out.println("Enter a single character that will rerpresent your opponent on the board");
         ...
         //Set up the game
            System.out.println();
            System.out.println("Now we can start the game. Top play, enter a number and your token shall be put "
            + "in its place.\nThe number go from 1-9, left to right. We shall see who will win this round.");
